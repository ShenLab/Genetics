...
for line in r:
    ...
    for e in line[-2].split(');'):
        ...
        if proband_geno == '1/1':
            parents_list.append(sample+'-01'+'('+Father_geno+')'+','+sample+'-02'+'('+Mother_geno+')')
        if proband_geno == '0/1':
            if '1' in Father_geno: # 0/1 0/1 x/x
                parents_list.append(sample+'-01'+'('+Father_geno+')')
            elif '0/0' in Father_geno: # 0/1 0/0 0/1 or 1/1 or ./.
                parents_list.append(sample+'-02'+'('+Mother_geno+')')
            else:
        ...
        proband_list.append(sample+'('+proband_geno+')')
